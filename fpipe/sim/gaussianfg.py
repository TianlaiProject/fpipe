"""Simulate gaussian foregrounds, in particular those in the style of Santos,
Cooray and Knox [1]_.
...
class ForegroundMap(maps.Map3d):
    ...
    def generate_weight(self, regen=False):
        ...
        rf = gaussianfield.RandomFieldA2F.like_map(self)
